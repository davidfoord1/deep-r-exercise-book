...
A [Quarto Book](https://quarto.org/docs/books/) is my weapon of choice here, so I'm taking the "Weaving" approach, so I'm going to skip most of this chapter, which is about getting set up and different modes of running R.
...
On top of that, `help()` works for checking a single function, but if want to say, explore a package, its function reference and related articles, a website usually has a much nicer user experience. I'd rather explore his stringi package via its website [stringi.gagolewski.com](https://stringi.gagolewski.com "stringi website"), for instance.
